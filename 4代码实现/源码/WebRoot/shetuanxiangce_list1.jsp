...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse">  
  <tr>
    ...
    <td  style="display:none"width="60" align="center" bgcolor="CCFFFF">操作</td>
  </tr>
 <% 
...
//txixixngdy
    ...
    String url = "shetuanxiangce_list2.jsp?1=1"; 
    String sql =  "select shetuanxiangce. * from shetuanxiangce,chengyuanxinxi where chengyuanxinxi.dengjiren=shetuanxiangce.faburen and chengyuanxinxi.yonghuming='"+request.getSession().getAttribute("username")+"'";
...
//youzuiping2
 ...
 <td style="display:none" width='80' align='center'><%=map.get("issh")%></td>
    ...
    <td style="display:none" width="60" align="center"><!--<a href="shetuanxiangce_updt.jsp?id=<%=map.get("id")%>">修改</a>-->  
	<!--<a href="shetuanxiangce_list2.jsp?scid=<%=map.get("id") %>" onClick="return confirm('真的要删除？')">删除</a> -->
	<a href="shetuanxiangce_detail.jsp?id=<%=map.get("id")%>">详细</a> </td>
  </tr>
  	<%
  }
   %>
