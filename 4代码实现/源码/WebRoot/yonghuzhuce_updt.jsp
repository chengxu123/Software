...
%>
  ...
  <br><br>
   <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">  
	 ...
	 <tr><td>手机号：</td><td><input name='shoujihao' type='text' id='shoujihao' value='' /></td></tr>
	 <tr><td>身高：</td><td><input name='shengao' type='text' id='shengao' value='' /></td></tr>
	 <tr><td>体重：</td><td><input name='tizhong' type='text' id='tizhong' value='' /></td></tr>
	 <tr><td>籍贯：</td><td><input name='jiguan' type='text' id='jiguan' value='' /></td></tr>
	 <tr><td>兴趣爱好：</td><td><input name='xingquaihao' type='text' id='xingquaihao' value='' /></td></tr>
	 <tr><td>学校：</td><td><input name='xuexiao' type='text' id='xuexiao' value='' /></td></tr>
	 <tr><td>专业：</td><td><input name='zhuanye' type='text' id='zhuanye' value='' /></td></tr>
	 ...
	 <tr><td>地址：</td><td><input name='dizhi' type='text' id='dizhi' size='50' value='' /></td></tr><tr><td>个人历程：</td><td><textarea name='gerenlicheng' cols='50' rows='5' id='gerenlicheng'></textarea></td></tr>
    <tr>
      <td>&nbsp;</td>
