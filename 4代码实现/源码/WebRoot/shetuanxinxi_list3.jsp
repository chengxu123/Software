...
//txixixngdy
    ...
    String url = "shetuanxinxi_list3.jsp?1=1"; 
...
//youzuiping2
  ...
  <tr>
    ...
    <td width="60" align="center"><a href="chengyuanxinxi_add.jsp?id=<%=map.get("id")%>">加入社团</a>  <a href="shetuanxinxi_list.jsp?scid=<%=map.get("id") %>" onClick="return confirm('真的要删除？')">删除</a> <a href="shetuanxinxidetail.jsp?id=<%=map.get("id")%>" target="_blank">详细</a> </td>
  </tr>
  	<%
  }
   %>
