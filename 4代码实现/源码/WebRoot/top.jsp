...
<div class="top_box">
    <div class="top_logo"><div align="center" style="color: #CCFFCC;font-size: 13pt;font-weight: bold;">大学生社团社交网站</div></div>
    <div class="top_nav">
      <div class="top_nav_sm">
		 		 <span style="float:right; padding-right:12px"> [<a href="index.jsp" target='_parent' ><strong>前台首页</strong></a>]  <!--[<a href="suoping.jsp" target='_parent' ><strong>暂时离开</strong></a>]--></span>
