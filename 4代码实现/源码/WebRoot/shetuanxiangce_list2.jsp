...
//txixixngdy
    ...
    String sql =  "select * from shetuanxiangce where faburen='"+request.getSession().getAttribute("username")+"' ";
...
//youzuiping2
 ...
 <td style="display:none" width='80' align='center'><%=map.get("issh")%></td>
    ...
    <td width="60" align="center"><a href="shetuanxiangce_updt.jsp?id=<%=map.get("id")%>">修改</a>  <a href="shetuanxiangce_list2.jsp?scid=<%=map.get("id") %>" onClick="return confirm('真的要删除？')">删除</a> <a href="shetuanxiangce_detail.jsp?id=<%=map.get("id")%>">详细</a> </td>
  </tr>
  	<%
  }
   %>
