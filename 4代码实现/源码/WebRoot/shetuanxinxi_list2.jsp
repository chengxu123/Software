...
//youzuiping2
 ...
 <td width='80' align='center'><%=map.get("issh")%></td>
    ...
    <td width="60" align="center"><a href="shetuanxinxi_updt.jsp?id=<%=map.get("id")%>">修改</a>  <a href="shetuanxinxi_list2.jsp?scid=<%=map.get("id") %>" onClick="return confirm('真的要删除？')">删除</a> <a href="shetuanxinxidetail.jsp?id=<%=map.get("id")%>" target="_blank">详细</a> </td>
  </tr>
  	<%
  }
   %>
