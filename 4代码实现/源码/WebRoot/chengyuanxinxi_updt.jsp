...
%>
  ...
  <br><br>
   ...
   <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">  
     ...
     <tr><td>入团日期：</td><td><input name='rutuanriqi' type='text' id='rutuanriqi' value='<%= mmm.get("rutuanriqi")%>' onClick="WdatePicker({'dateFmt':'yyyy-MM-dd'})" readonly='readonly'  /></td></tr>
     <tr><td>报名人：</td><td><input name='baomingren' type='text' id='baomingren' value='<%= mmm.get("baomingren")%>' style='border:solid 1px #000000; color:#666666' /></td></tr>
