...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse">  
  <tr>
    ...
    <td  style="display:none"bgcolor='#CCFFFF'>报名人</td>
...
//txixixngdy
    ...
    String sql =  "select * from chengyuanxinxi where yonghuming='"+request.getSession().getAttribute("username")+"' ";
...
//youzuiping2
 ...
 <td style="display:none"><%=map.get("baomingren") %></td>
 
 
    
    <td width="60" align="center">
	<a href="kaoqin_add.jsp?id=<%=map.get("id")%>">考勤</a>  
	
	 <!--<a href="chengyuanxinxi_detail.jsp?id=<%=map.get("id")%>">详细</a>--> </td>
  </tr>
  	<%
  }
   %>
