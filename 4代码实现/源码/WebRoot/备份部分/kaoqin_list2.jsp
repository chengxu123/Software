...
//txixixngdy
    ...
    String url = "kaoqin_list2.jsp?1=1"; 
    String sql =  "select * from kaoqin where kaoqinchengyuan='"+request.getSession().getAttribute("username")+"' ";
...
//youzuiping2
 ...
 <td width='80' align='center'><%=map.get("issh")%></td>
    ...
    <td width="60" align="center"><a href="kaoqin_updt.jsp?id=<%=map.get("id")%>">修改</a> 
	 <a href="kaoqin_list2.jsp?scid=<%=map.get("id") %>" onClick="return confirm('真的要删除？')">删除</a>
	  </td>
  </tr>
  	<%
  }
