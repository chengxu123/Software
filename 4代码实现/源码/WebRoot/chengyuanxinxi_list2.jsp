...
//txixixngdy
    ...
    String url = "chengyuanxinxi_list2.jsp?1=1"; 
    String sql =  "select * from chengyuanxinxi where dengjiren='"+request.getSession().getAttribute("username")+"' ";
...
//youzuiping2
 ...
 <td><%=map.get("dengjiren") %></td>
 
 
 <td><%=map.get("issh") %></td>
    <td width="60" align="center"><a href="chengyuanxinxi_updt.jsp?id=<%=map.get("id")%>">修改</a>  <a href="chengyuanxinxi_list2.jsp?scid=<%=map.get("id") %>" onClick="return confirm('真的要删除？')">删除</a> <a href="chengyuanxinxi_detail.jsp?id=<%=map.get("id")%>">详细</a> </td>
  </tr>
  	<%
  }
   %>
